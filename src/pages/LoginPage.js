...
const LoginPage = () => {
  ...
  return (
    <main className="flex flex-col justify-center m-20">
      ...
      <h1 className="self-center font-bold text-xl mb-2 text-[#1C232E]">
        Login
      </h1>
      <Formik
        initialValues={{
      ...
      >
        {(formik) => (
          ...
          >
            <div className="mb-3">
              <label className="text-[#288D85] text-sm" htmlFor="email">
                Email
              </label>
              <br />
              <input
            ...
            <div className="mb-3">
              <label className="text-[#288D85] text-sm" htmlFor="password">
                Senha
              </label>
              <br />
              <input
